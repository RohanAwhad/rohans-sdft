...
Usage:
    python synthetic_algebra_dataset.py [--n-custom 1000] [--n-standard 1000] [--seed 42] [--output data]
"""
...
def main():
    ...
    print(f"Generating dataset (custom={args.n_custom}, standard={args.n_standard}, seed={args.seed})...")
